...
const Sobre = ({ setSelectedTeam }: SobreProps) => {
  ...
  return (
    <main className="flex flex-col grow max-w-7xl mx-auto px-4 py-12">
      {/* Casca da página padronizada em max-w-7xl (mesma largura do resto do
          site); o texto corrido ganha seu próprio max-w-3xl aqui dentro só
          pra não esticar a linha de leitura numa tela larga — não é uma
          largura de página concorrente, é tipografia normal. */}
      <div className="max-w-3xl">
        ...
        <p className="text-xl">
          ...
          descobrir onde conseguir assistir ao jogo do seu time. As informações estão disponíveis
          na internet, mas de maneira pulverizada e pouco estruturada. O <i>Onde Vai Passar</i>{" "}
          busca esses dados por meio de webscraping e os disponibiliza em um só lugar.
        </p>
      </div>
    </main>
  );
